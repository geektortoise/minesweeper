...
import { AxoBoardService } from '../../service/board/circular-board/axo-board.service';
...
export class AxoBoardComponent extends BoardComponent<ClassicalBoard> {
  private generationStrategy: GenerationStrategy = 'AT_FIRST_CLICK';

  constructor(
    protected override tileService: AxoBoardService,
